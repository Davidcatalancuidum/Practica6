                    ...
                    <div className="item">
                        ...
                        <div className="details">
                            ...
                            <div className="detailItem">
                                ...
                                <span className="itemValue">yyfhsggtht@gmail.com</span>
                            </div>
                            <div className="detailItem">
                                <span className="itemKey">Phone:</span>
                                <span className="itemValue">+35 923 433 324</span>
                            </div>
                            <div className="detailItem">
                                <span className="itemKey">Address:</span>
                                <span className="itemValue">Elton St. 234 Garden Yd. Madrid</span>
                            </div>
                            <div className="detailItem">
